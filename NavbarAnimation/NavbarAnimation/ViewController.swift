...
class ViewController: UIViewController, UITableViewDelegate,UITableViewDataSource{
    ...
    @IBOutlet weak var SnacksLabelHeight: NSLayoutConstraint!
    ...
    func NavBarClosed(){
        UIView.animate(withDuration:0.2){
            ...
            self.SnacksLabelHeight.constant = 80
    ...
    func NavBarOpened(){
        UIView.animate(withDuration:0.2){
            ...
            self.SnacksLabelHeight.constant = 43
    ...
    @objc func tap1(){
        elements.append("Oreos")
        self.TV.reloadData()
    }
    @objc func tap2(){
        elements.append("Ramen")
        self.TV.reloadData()
    }
    @objc func tap3(){
        elements.append("Pizza Pockets")
        self.TV.reloadData()
    }
    @objc func tap4(){
        elements.append("Popsicle")
        self.TV.reloadData()
    }
    @objc func tap5(){
        elements.append("Pop Tarts")
        self.TV.reloadData()
    }
}
